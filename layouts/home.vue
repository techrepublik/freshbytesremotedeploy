                    ...
                    <li>
                        <button type="button"
                            ...
                            <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                ...
                                viewBox="0 0 20 20">
                                <path
                                    d="M2 5a2 2 0 012-2h2a2 2 0 012 2v1h4V5a2 2 0 114 0v1h2a2 2 0 012 2v9a2 2 0 01-2 2H4a2 2 0 01-2-2V5zm6 3v2a1 1 0 002 0V8a1 1 0 10-2 0zm4 0v2a1 1 0 002 0V8a1 1 0 10-2 0z" />
                            </svg>
                        ...
                        <ul id="dropdown-transactions" class="hidden py-2 space-y-2">
                            <li>
                                <NuxtLink to="/home/transactions"
                                    ...
                                    <span class="ms-3">All Transactions</span>
                                </NuxtLink>
                            </li>
                            <li>
                                <NuxtLink to="/home/transactions/singletransactions"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                    <svg class="flex-shrink-0 w-4 h-4 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                        fill="currentColor" viewBox="0 0 20 20">
                                        <path
