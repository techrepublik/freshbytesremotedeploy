<script setup>
    ...
    const emit = defineEmits(['closeProductModal']); // List of component actions
    ...
    <div v-if="showProductModal"
        ...
        <div class="bg-white rounded-xl shadow-lg w-full max-w-2xl p-8 relative h-screen overflow-y-auto">
            ...
            <div class="flex justify-end space-x-2 mt-6">
                <button class="flex items-center px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 text-sm">
                ...
                <button class="flex items-center px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 text-sm">
                    <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
