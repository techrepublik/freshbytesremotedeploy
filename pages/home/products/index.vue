...
<template>
    ...
    <div class="relative min-h-screen">
        ...
        <!-- Add Product Modal -->
        <!-- <ProductAddModal :show-add-product-modal="showAddProductModal" :new-product="newProduct" :sellers="sellers" :subcategories="subcategories"></ProductAddModal>> --> // WAG GALAWIN!
