...
<template>
  ...
  <div class="h-screen flex items-center bg-gradient-to-br from-green-50 to-green-100 relative overflow-hidden">
    ...
    <div class="relative z-30 w-full max-w-xl ml-60 space-y-6">
      ...
      <!-- Auth Form -->
      <div class="bg-white/90 backdrop-blur-md p-12 rounded-2xl shadow-2xl w-full space-y-8">
        <h2 class="text-4xl font-semibold mb-20 text-center">Join Us</h2>
        <RegisterForm @child-action="handleLogin" :form="form" :isLoading="isLoading" />
      </div>
    </div>
